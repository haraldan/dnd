...
# Load PDFs
header_doc = pymupdf.open(header_pdf_path)
content_doc = pymupdf.open(content_pdf_path)
...
for i in range(len(content_doc)):
    ...
    rect_img = pymupdf.Rect(0, 0, page_width, header_height)
